...
export default function Home() {
  ...
  useEffect(() => {
    const moviefun = async () => {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/trending/movie/week?api_key="Enter_here_API_key"`
      );
    ...
    const tvfun = async () => {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/trending/tv/week?api_key="Enter_here_API_key"`
      );
  ...
  useEffect(() => {
    const upcomingmoviefun = async () => {
      const { data } = await axios.get(
        ` https://api.themoviedb.org/3/movie/upcoming?api_key="Enter_here_API_key"&page=${l1}`
      );
  ...
  useEffect(() => {
    const upcomingtvfun = async () => {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/tv/on_the_air?api_key="Enter_here_API_key"&language=en-US&page=${l2}`
      );
  ...
  useEffect(() => {
    const popmoviefun = async () => {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/movie/popular?api_key="Enter_here_API_key"&page=${l3}&region=IN`
      );
  ...
  useEffect(() => {
    const poptvfun = async () => {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/tv/popular?api_key="Enter_here_API_key"&page=${l4}&region=IN`
      );
  ...
  useEffect(() => {
    const topmoviefun = async () => {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/movie/top_rated?api_key="Enter_here_API_key"&language=en-US&page=${l5}&region=IN`
      );
  ...
  useEffect(() => {
    const toptvfun = async () => {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/tv/top_rated?api_key="Enter_here_API_key"&language=en-US&page=${l6}&region=IN`
      );
